...
(function ($, window) {
  ...
  FreezeTable.prototype.buildScrollBar = function() {
    ...
    var fixBrowserScrollbar = $(window).outerWidth() - $(window).width();

    // Scroll wrap container
    var $scrollBarContainer = $('<div class="'+this.scrollBarWrapClass+'"></div>')
      .css('width', this.$table.width() - 17)
      .css('height', 1);
    ...
    this.$scrollBarWrap = $('<div class="'+this.scrollBarWrapClass+'"></div>')
      ...
      .css('bottom', 0)
      .css('z-index', 2)
      .css('width', this.$tableWrapper.width() - fixBrowserScrollbar)
    ...
    this.$container.on('resize.'+this.namespace, function() {
      ...
      // Update Wrap
      that.$scrollBarWrap.css('width', that.$tableWrapper.width() + fixBrowserScrollbar);
    });
  }
