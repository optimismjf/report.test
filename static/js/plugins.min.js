...
function(n) {
    n(function() {
        function e() {
            n(window).width() <= 1e3 ? (n("#slider-article").addClass("owl-carousel"), n("#slider-article").owlCarousel({
                loop: !0,
                margin: 0,
                nav: !1,
                items: 1,
            ...
            })) : n("#slider-article").removeClass("owl-carousel").trigger("destroy.owl.carousel")
        }
        ...
        function t() {
            n(window).width() <= 767 ? (n(".b-projects-empty__actions").addClass("owl-carousel"), n(".b-projects-empty__actions").owlCarousel({
                ...
                autoplayTimeout: 7e3,
                autoplayHoverPause: !0
            })) : n(".b-projects-empty__actions").removeClass("owl-carousel").trigger("destroy.owl.carousel")
        }
        n(".hamburger").click(function() {
            n(this).toggleClass("is-active"), n('.front-page__header').toggleClass("is-active"), n(".hamburger").hasClass("is-active"), n("#navigation").slideToggle("blind")
        }), 
        n(".b-user__name-wrapper").click(function() {
            if (n(window).outerWidth() < 1200) {
                n(".b-user__name-ico").toggleClass("is-active"), n(".b-user__name-ico").hasClass("is-active"), n("#navigation-profile").slideToggle("blind")
            }
